...
public class TutorialFragment extends Fragment {
    ...
    private class DemoAdapter extends PagerAdapter{
        ...
        private int[] icons = new int[]{R.drawable.ic_launcher, R.drawable.demo_dashboard, R.drawable.demo_recommenations, R.drawable.demo_recommenations, R.drawable.demo_watchlist, R.drawable.demo_portfolio, R.drawable.demo_market_news };
